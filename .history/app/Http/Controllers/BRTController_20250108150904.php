...
class BRTController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'reserved_amount' => 'required|numeric', // Here, Ensured the reserved_amount is numeric
            'status' => 'required|in:active,expired', // Also, Status can be either active or expired
        ]);

        // Creating the BRT and associating it with the authenticated user
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'brt_code.required' => 'The BRT code is required.',
            'brt_code.unique' => 'This BRT code has already been used.',
            'reserved_amount.numeric' => 'The reserved amount must be a number.',
            'status.in' => 'The status must be either active or expired.',
        ]);
