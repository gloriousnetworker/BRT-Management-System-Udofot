    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="mt-8 grid grid-cols-3 gap-6">
                <div class="bg-white shadow-lg rounded-lg p-6">
                    <div class="text-lg font-semibold text-gray-700">BRTs Created Per Day</div>
                    <div class="text-3xl font-bold text-gray-900">{{ $brtsPerDay }}</div>
                </div>
                <div class="bg-white shadow-lg rounded-lg p-6">
                    <div class="text-lg font-semibold text-gray-700">BRTs Created Per Week</div>
                    <div class="text-3xl font-bold text-gray-900">{{ $brtsPerWeek }}</div>
                </div>
                <div class="bg-white shadow-lg rounded-lg p-6">
                    <div class="text-lg font-semibold text-gray-700">BRTs Created Per Month</div>
                    <div class="text-3xl font-bold text-gray-900">{{ $brtsPerMonth }}</div>
                </div>
            </div>
        </div>
        @endif
