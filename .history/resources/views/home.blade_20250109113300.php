        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                ...
                <div class="bg-purple-100 p-6 rounded-lg">
                    <div class="text-lg font-semibold text-gray-700">Total Reserved Blume Coins</div>
                    <div class="text-3xl font-bold text-gray-900">{{ $totalReservedAmount }} BLUME COINS</div>
                </div>
            </div>
            <div class="mt-6">
                <div class="text-lg font-semibold text-gray-800">BRTs Created Analytics</div>
                <div class="grid grid-cols-3 gap-6 mt-4">
                    <div class="bg-blue-50 p-6 rounded-lg">
                        <div class="text-md font-medium text-gray-700">BRTs Created Today</div>
                        <div class="text-2xl font-bold text-gray-900">{{ $brtsToday }}</div>
                    </div>
                    <div class="bg-blue-50 p-6 rounded-lg">
                        <div class="text-md font-medium text-gray-700">BRTs Created This Week</div>
                        <div class="text-2xl font-bold text-gray-900">{{ $brtsThisWeek }}</div>
                    </div>
                    <div class="bg-blue-50 p-6 rounded-lg">
                        <div class="text-md font-medium text-gray-700">BRTs Created This Month</div>
                        <div class="text-2xl font-bold text-gray-900">{{ $brtsThisMonth }}</div>
                    </div>
                </div>
            </div>
        </div>
