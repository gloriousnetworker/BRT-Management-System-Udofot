        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                <div class="bg-blue-100 p-6 rounded-lg">
                    ...
                    <div class="text-3xl font-bold text-gray-900">150</div> <!-- Dummy data for total BRTs -->
                </div>
                <div class="bg-yellow-100 p-6 rounded-lg">
                    <div class="text-lg font-semibold text-gray-700">Active BRTs</div>
                    <div class="text-3xl font-bold text-gray-900">85</div> <!-- Dummy data for active BRTs -->
                </div>
                <div class="bg-green-100 p-6 rounded-lg">
                    <div class="text-lg font-semibold text-gray-700">Expired BRTs</div>
                    <div class="text-3xl font-bold text-gray-900">40</div> <!-- Dummy data for expired BRTs -->
                </div>
                <div class="bg-red-100 p-6 rounded-lg">
                    <div class="text-lg font-semibold text-gray-700">Pending BRTs</div>
                    <div class="text-3xl font-bold text-gray-900">25</div> <!-- Dummy data for pending BRTs -->
                </div>
            </div>
            ...
            <div class="mt-6">
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="grid grid-cols-3 gap-6 mt-4">
                        <div class="bg-blue-100 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-gray-900">10</div> <!-- Dummy data for today -->
                        </div>
                        <div class="bg-blue-100 p-4 rounded-lg">
                            <div class="text-md font-semibold text-gray-700">This Week</div>
                            <div class="text-xl font-bold text-gray-900">40</div> <!-- Dummy data for this week -->
                        </div>
                        <div class="bg-blue-100 p-4 rounded-lg">
                            <div class="text-md font-semibold text-gray-700">This Month</div>
                            <div class="text-xl font-bold text-gray-900">120</div> <!-- Dummy data for this month -->
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg mt-6">
                    ...
                    <div class="text-3xl font-bold text-gray-900">2500 BLUME COINS</div> <!-- Dummy data for total reserved coins -->
                </div>
            </div>
        </div>
        @endif
