...
<!-- Listen for the event on the receiver's channel -->
<script>
    Echo.channel('ticket.' + {{ Auth::id() }})
        .listen('TicketCreatedNotification', (event) => {
            alert('You have received a new ticket: ' + event.ticket.brt_code);
            // You can customize how to display this notification on the frontend
        });
</script>
@endpush
