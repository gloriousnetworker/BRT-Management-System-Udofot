...
<script>
    ...
    // Add Pusher event trigger on button click
    document.getElementById('create-ticket-btn').addEventListener('click', function(e) {
        // Trigger Pusher notification when the button is clicked
        pusher.trigger('tickets', 'TicketCreated', {
            brt_code: document.getElementById('brt_code').value,
            reserved_amount: document.getElementById('reserved_amount').value
        });
    });
</script>
