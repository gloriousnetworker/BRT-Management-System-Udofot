...
<head>
    ...
    <!-- Toastr CSS -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">    <!-- Toastr JS -->
    ...
    <script>
        ...
        function showNotification(ticket) {
            ...
            notificationElement.classList.add('notification', 'bg-blue-500', 'text-white', 'p-4', 'rounded', 'fixed', 'top-4', 'right-4');
            notificationElement.textContent = `New ticket created with BRT Code: ${ticket.brt_code}`;
