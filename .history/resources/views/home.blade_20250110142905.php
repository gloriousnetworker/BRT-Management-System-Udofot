    ...
    <div id="ticket-display" class="mt-4 space-y-4">
        ...
        <div class="bg-green-100 p-4 rounded-lg flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <!-- Edit Ticket Form -->
                <div id="edit-ticket-{{ $ticket->id }}" class="hidden">
                    <form method="POST" action="{{ route('tickets.update', $ticket->id) }}">
                        ...
                        <div class="mb-4">
                            <label for="brt_code" class="block text-sm font-medium text-gray-700">BRT Code</label>
                            <input type="text" name="brt_code" value="{{ $ticket->brt_code }}" id="brt_code" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                        </div>
                        <div class="mb-4">
                            <label for="reserved_amount" class="block text-sm font-medium text-gray-700">Reserved Amount</label>
                            <input type="number" name="reserved_amount" value="{{ $ticket->reserved_amount }}" id="reserved_amount" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                        </div>
                        <div class="mb-4">
                            <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
                            <select name="status" id="status" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
